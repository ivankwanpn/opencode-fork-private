...
export const dict = {
  ...
  "mcp.status.disconnected": "연결 안 됨",
  "mcp.status.failed": "실패",
  "mcp.status.needs_auth": "인증 필요",
  "mcp.auth.clickToAuthenticate": "클릭하여 인증",
  "mcp.status.disabled": "비활성화됨",
  "plugin.status.enabled": "활성화됨",
  "plugin.status.disabled": "비활성화됨",
  "plugin.catalog.loading": "플러그인 불러오는 중…",
  "plugin.catalog.empty": "사용 가능한 플러그인이 없습니다",
  "plugin.catalog.failed": "플러그인을 불러올 수 없습니다",
  "plugin.catalog.retry": "다시 시도",
  "plugin.catalog.stale": "마지막으로 불러온 플러그인 목록을 표시합니다",
  "plugin.catalog.filteredEmpty": "이 검색과 일치하는 플러그인이 없습니다",
  "plugin.runtime.initializing": "초기화 중",
  "plugin.runtime.ready": "준비됨",
  "plugin.runtime.degraded": "일부 사용 가능",
  "plugin.runtime.failed": "사용할 수 없음",
  "plugin.runtime.stale": "상태가 최신이 아닐 수 있습니다",
  "plugin.capability.skills": "스킬",
  "plugin.capability.commands": "명령",
  "plugin.capability.mcp": "MCP",
  "plugin.capability.plugin": "플러그인 훅",
  "plugin.capability.tools": "도구",
