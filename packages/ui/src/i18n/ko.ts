export const dict = {
  ...
  "ui.sessionTurn.status.compacting": "컨텍스트 압축 중",
  "ui.sessionTurn.status.waitingForInput": "입력 대기 중",
  ...
  "ui.messagePart.shell.background": "백그라운드로 이동",
  "ui.messagePart.shell.backgroundUnavailable": "일치하는 포그라운드 셸 작업을 찾을 수 없습니다.",
