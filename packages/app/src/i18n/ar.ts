...
export const dict = {
  ...
  "plugin.status.enabled": "مفعّل",
  "plugin.status.disabled": "معطّل",
  "plugin.catalog.loading": "جارٍ تحميل الإضافات…",
  "plugin.catalog.empty": "لا توجد إضافات متاحة",
  "plugin.catalog.failed": "تعذر تحميل الإضافات",
  "plugin.catalog.retry": "إعادة المحاولة",
  "plugin.catalog.stale": "يتم عرض آخر قائمة إضافات تم تحميلها",
  "plugin.catalog.filteredEmpty": "لا توجد إضافات تطابق هذا البحث",
  "plugin.runtime.initializing": "جارٍ التهيئة",
  "plugin.runtime.ready": "جاهز",
  "plugin.runtime.degraded": "متاح جزئيًا",
  "plugin.runtime.failed": "غير متاح",
  "plugin.runtime.stale": "قد تكون الحالة قديمة",
  "plugin.capability.skills": "المهارات",
  "plugin.capability.commands": "الأوامر",
  "plugin.capability.mcp": "MCP",
  "plugin.capability.plugin": "خطافات الإضافة",
  "plugin.capability.tools": "الأدوات",
  ...
  "settings.agents.section.coordinators": "المنسقون الرئيسيون",
  "settings.agents.section.subagents": "الوكلاء الفرعيون للمهام",
  "settings.agents.role.build": "منسق رئيسي بصلاحيات تنفيذ كاملة.",
  "settings.agents.role.plan": "منسق رئيسي للتخطيط والعمل للقراءة فقط.",
  "settings.agents.role.general": "وكيل فرعي عام للمهام المتنوعة واسعة النطاق.",
  "settings.agents.role.explore": "وكيل فرعي سريع للقراءة فقط لاستكشاف الملفات والرموز.",
  "settings.agents.role.research": "وكيل فرعي متعمق للقراءة فقط للبحث القائم على الأدلة وتحليل البنية.",
  "settings.agents.role.worker": "وكيل فرعي قوي للتنفيذ مخصص لتغييرات الشفرة وإصلاح الأخطاء والاختبارات والتحقق.",
