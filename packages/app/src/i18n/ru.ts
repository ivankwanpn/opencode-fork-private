...
export const dict = {
  ...
  "provider.oauth.title": "Поставщик OAuth",
  "provider.oauth.authManaged": "Учётные данные управляются этим подключением.",
  "provider.oauth.discovery.discover": "Найти модели",
  "provider.oauth.discovery.discovering": "Поиск моделей...",
  "provider.oauth.discovery.success": "Текущие модели найдены",
  "provider.oauth.discovery.cached": "Показаны кэшированные или статические модели из каталога.",
  "provider.oauth.discovery.failure": "Не удалось найти модели. Повторите попытку.",
  "provider.oauth.discovery.unsupported": "Этот поставщик не поддерживает поиск моделей.",
  "provider.oauth.discovery.empty": "Модели не найдены.",
  "provider.oauth.models.search": "Поиск моделей",
  "provider.oauth.models.empty": "Нет моделей, соответствующих вашему запросу.",
  "provider.oauth.models.context": "Локальное переопределение контекста",
  ...
  "plugin.catalog.loading": "Загрузка плагинов…",
  "plugin.catalog.empty": "Нет доступных плагинов",
  "plugin.catalog.failed": "Не удалось загрузить плагины",
  "plugin.catalog.retry": "Повторить",
  "plugin.catalog.stale": "Показан последний загруженный список плагинов",
  "plugin.catalog.filteredEmpty": "Нет плагинов, соответствующих поиску",
  "plugin.runtime.initializing": "Инициализация",
  "plugin.runtime.ready": "Готово",
  "plugin.runtime.degraded": "Частично доступно",
  "plugin.runtime.failed": "Недоступно",
  "plugin.runtime.stale": "Состояние может быть устаревшим",
  "plugin.capability.skills": "Навыки",
  "plugin.capability.commands": "Команды",
  "plugin.capability.mcp": "MCP",
  "plugin.capability.plugin": "Хуки плагина",
  "plugin.capability.tools": "Инструменты",
  ...
  "context.usage.window": "Контекстное окно",
  "context.usage.used": "Использовано {{used}} / {{limit}}",
