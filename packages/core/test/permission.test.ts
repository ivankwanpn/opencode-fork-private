...
describe("PermissionV2", () => {
  ...
  it.effect("applies the latest promoted prompt tool policy after agent rules without active user history", () =>
    Effect.gen(function* () {
      ...
      yield* db
        ...
        .values({
          id: SessionMessage.ID.make("msg_policy_allow"),
          session_id: sessionID,
          prompt: Prompt.make({ text: "Allow read", tools: { read: true } }),
          delivery: "steer",
          admitted_seq: 0,
          promoted_seq: 1,
          time_created: 0,
      ...
      yield* db
        .insert(SessionInputTable)
        .values({
          id: SessionMessage.ID.make("msg_policy_deny"),
          session_id: sessionID,
          prompt: Prompt.make({ text: "Deny read", tools: { read: false } }),
          delivery: "steer",
          admitted_seq: 2,
          promoted_seq: 3,
          time_created: 1,
