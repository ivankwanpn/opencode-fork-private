...
export const dict = {
  ...
  "plugin.catalog.loading": "Indlæser plugins…",
  "plugin.catalog.empty": "Ingen plugins tilgængelige",
  "plugin.catalog.failed": "Plugins kunne ikke indlæses",
  "plugin.catalog.retry": "Prøv igen",
  "plugin.catalog.stale": "Viser den senest indlæste pluginliste",
  "plugin.catalog.filteredEmpty": "Ingen plugins matcher denne søgning",
  "plugin.runtime.initializing": "Initialiserer",
  "plugin.runtime.ready": "Klar",
  "plugin.runtime.degraded": "Delvist tilgængelig",
  "plugin.runtime.failed": "Ikke tilgængelig",
  "plugin.runtime.stale": "Status kan være forældet",
  "plugin.capability.skills": "Færdigheder",
  "plugin.capability.commands": "Kommandoer",
  "plugin.capability.mcp": "MCP",
  "plugin.capability.plugin": "Plugin-hooks",
  "plugin.capability.tools": "Værktøjer",
