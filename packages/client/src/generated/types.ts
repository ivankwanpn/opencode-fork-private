...
export const isSessionTurnConflictError = (value: unknown): value is SessionTurnConflictError =>
  typeof value === "object" && value !== null && "_tag" in value && value["_tag"] === "SessionTurnConflictError"
...
export const isCustomProviderValidationError = (value: unknown): value is CustomProviderValidationError =>
  typeof value === "object" && value !== null && "_tag" in value && value["_tag"] === "CustomProviderValidationError"
...
export const isCustomProviderDiscoveryError = (value: unknown): value is CustomProviderDiscoveryError =>
  typeof value === "object" && value !== null && "_tag" in value && value["_tag"] === "CustomProviderDiscoveryError"
...
export const isCustomProviderConflictError = (value: unknown): value is CustomProviderConflictError =>
  typeof value === "object" && value !== null && "_tag" in value && value["_tag"] === "CustomProviderConflictError"
...
export const isCustomProviderConfigureError = (value: unknown): value is CustomProviderConfigureError =>
  typeof value === "object" && value !== null && "_tag" in value && value["_tag"] === "CustomProviderConfigureError"
...
export type McpNotFoundError = { readonly _tag: "McpNotFoundError"; readonly name: string; readonly message: string }
...
export const isProjectOperationError = (value: unknown): value is ProjectOperationError =>
  typeof value === "object" && value !== null && "name" in value && value["name"] === "ProjectOperationError"
...
export const isWorktreeOperationError = (value: unknown): value is WorktreeOperationError =>
  typeof value === "object" && value !== null && "name" in value && value["name"] === "WorktreeOperationError"
...
export type SessionsUpdateInput = {
  readonly sessionID: { readonly sessionID: string }["sessionID"]
  readonly title?: { readonly title?: string | null; readonly archived?: number | null | null }["title"]
  readonly archived?: { readonly title?: string | null; readonly archived?: number | null | null }["archived"]
}
...
export type SessionsShareOutput = { readonly data: { readonly url: string } }["data"]
...
export type SessionsHistoryOutput = {
  readonly data: ReadonlyArray<
    ...
    | {
        ...
        readonly durable?: { readonly aggregateID: string; readonly seq: number; readonly version: number }
        readonly location?: { readonly directory: string; readonly workspaceID?: string }
        readonly data: { readonly timestamp: number; readonly sessionID: string; readonly attemptID: string }
      }
    | {
        readonly id: string
        readonly metadata?: { readonly [x: string]: JsonValue }
...
export type WorktreesCreateInput = {
  ...
  readonly name?: { readonly name?: string; readonly startCommand?: string }["name"]
  readonly startCommand?: { readonly name?: string; readonly startCommand?: string }["startCommand"]
}

export type WorktreesCreateOutput = { readonly name: string; readonly branch?: string; readonly directory: string }
...
export type CapabilitiesGetOutput = { readonly backgroundSubagents: boolean }
...
export type ConsoleSwitchOrgInput = {
  ...
  readonly accountID: { readonly accountID: string; readonly orgID: string }["accountID"]
  readonly orgID: { readonly accountID: string; readonly orgID: string }["orgID"]
}
...
export type ConfigUpdateInput = { readonly config: { readonly config: JsonValue }["config"] }
...
export type ServerPluginsRefreshInput = { readonly name: { readonly name: string }["name"] }
...
export type ServerPluginsInstallInput = { readonly id: { readonly id: string }["id"] }
...
export type ServerPluginsEnableInput = { readonly id: { readonly id: string }["id"] }
...
export type ProjectCopiesGenerateNameInput = {
  ...
  readonly context?: { readonly context?: string | undefined }["context"]
}

export type ProjectCopiesGenerateNameOutput = { readonly name: string }
