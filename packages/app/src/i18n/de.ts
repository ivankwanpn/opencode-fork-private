...
export const dict = {
  ...
  "provider.oauth.title": "OAuth-Anbieter",
  "provider.oauth.authManaged": "Die Zugangsdaten werden von dieser Verbindung verwaltet.",
  "provider.oauth.discovery.discover": "Modelle ermitteln",
  "provider.oauth.discovery.discovering": "Modelle werden ermittelt...",
  "provider.oauth.discovery.success": "Aktuelle Modelle ermittelt",
  "provider.oauth.discovery.cached": "Zwischengespeicherte oder statische Katalogmodelle werden angezeigt.",
  "provider.oauth.discovery.failure": "Modelle konnten nicht ermittelt werden. Bitte erneut versuchen.",
  "provider.oauth.discovery.unsupported": "Dieser Anbieter unterstützt keine Modellerkennung.",
  "provider.oauth.discovery.empty": "Es wurden keine Modelle ermittelt.",
  "provider.oauth.models.search": "Modelle suchen",
  "provider.oauth.models.empty": "Keine Modelle entsprechen Ihrer Suche.",
  "provider.oauth.models.context": "Lokale Kontextüberschreibung",
  ...
  "plugin.status.enabled": "Aktiviert",
  "plugin.status.disabled": "Deaktiviert",
  "plugin.catalog.loading": "Plugins werden geladen…",
  "plugin.catalog.empty": "Keine Plugins verfügbar",
  "plugin.catalog.failed": "Plugins konnten nicht geladen werden",
  "plugin.catalog.retry": "Erneut versuchen",
  "plugin.catalog.stale": "Die zuletzt geladene Plugin-Liste wird angezeigt",
  "plugin.catalog.filteredEmpty": "Keine Plugins entsprechen dieser Suche",
  "plugin.runtime.initializing": "Wird initialisiert",
  "plugin.runtime.ready": "Bereit",
  "plugin.runtime.degraded": "Teilweise verfügbar",
  "plugin.runtime.failed": "Nicht verfügbar",
  "plugin.runtime.stale": "Status ist möglicherweise veraltet",
  "plugin.capability.skills": "Skills",
  "plugin.capability.commands": "Befehle",
  "plugin.capability.mcp": "MCP",
  "plugin.capability.plugin": "Plugin-Hooks",
  "plugin.capability.tools": "Werkzeuge",
  ...
  "context.usage.window": "Kontextfenster",
  "context.usage.used": "Verwendet {{used}} / {{limit}}",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
