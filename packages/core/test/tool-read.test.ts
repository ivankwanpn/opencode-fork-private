...
describe("ReadTool", () => {
    ...
    Effect.gen(function* () {
      ...
      expect(
        ...
        value: {
          ...
          encoding: "utf8",
          mime: "text/plain",
          loaded: [AbsolutePath.make(path.join(process.cwd(), "README.md"))],
        },
      })
  ...
  it.effect("lists a bounded directory page through read", () =>
    Effect.gen(function* () {
      ...
      ).toEqual({ type: "json", value: { entries: [], truncated: false, loaded: [] } })
    ...
    Effect.gen(function* () {
      ...
      expect(
        ...
        value: {
          ...
          truncated: true,
          next: 3,
          loaded: [AbsolutePath.make(path.join(process.cwd(), "large.txt"))],
        },
      })
      expect(readCalls).toEqual([
