export const customProviderEnglish = {
  "provider.custom.protocol.label": "Protocol",
  "provider.custom.protocol.openaiResponses": "OpenAI Responses",
  "provider.custom.protocol.openaiCompatible": "OpenAI-compatible",
  "provider.custom.protocol.anthropicMessages": "Anthropic Messages",
  "provider.custom.discovery.title": "Model discovery",
  "provider.custom.discovery.discover": "Discover Models",
  "provider.custom.discovery.discovering": "Discovering...",
  "provider.custom.discovery.retry": "Retry",
  "provider.custom.discovery.search": "Search discovered models",
  "provider.custom.discovery.addSelected": "Add Selected",
  "provider.custom.discovery.empty": "No models were discovered",
  "provider.custom.discovery.failure": "Model discovery failed",
  "provider.custom.discovery.manualFallback": "You can always add a model manually.",
  "provider.custom.unavailable": "Custom providers are unavailable on this server",
  "provider.custom.models.reasoning": "Supports reasoning",
  "provider.custom.models.context.label": "Context window",
  "provider.custom.models.context.placeholder": "e.g. 128000",
  "provider.custom.models.output.label": "Maximum output",
  "provider.custom.models.output.placeholder": "e.g. 8192",
  "provider.custom.error.limit": "Must be a positive whole number",
  "provider.custom.error.limitPair": "Context and output limits must be provided together",
  "provider.custom.error.outputExceedsContext": "Maximum output must not exceed the context window",
  "provider.custom.error.header.format": "Invalid header name",
  "provider.custom.field.apiKey.editDescription": "Leave empty to keep the existing API key.",
} as const
...
export const dict = {
  ...
  "provider.oauth.title": "OAuth provider",
  "provider.oauth.authManaged": "Credentials are managed by this connection.",
  "provider.oauth.discovery.discover": "Discover models",
  "provider.oauth.discovery.discovering": "Discovering models...",
  "provider.oauth.discovery.success": "Live models discovered",
  "provider.oauth.discovery.cached": "Showing cached or static catalog models.",
  "provider.oauth.discovery.failure": "Couldn't discover models. Try again.",
  "provider.oauth.discovery.unsupported": "Model discovery isn't supported by this provider.",
  "provider.oauth.discovery.empty": "No models were discovered.",
  "provider.oauth.models.search": "Search models",
  "provider.oauth.models.empty": "No models match your search.",
  "provider.oauth.models.context": "Local context override",
  ...
  "settings.agents.section.coordinators": "Primary coordinators",
  "settings.agents.section.subagents": "Task subagents",
  "settings.agents.role.build": "Primary coordinator with full execution permissions.",
  "settings.agents.role.plan": "Primary coordinator for planning and read-only work.",
  "settings.agents.role.general": "General-purpose subagent for broad mixed-scope tasks.",
  "settings.agents.role.explore": "Fast read-only subagent for file and symbol exploration.",
  "settings.agents.role.research": "Deep read-only subagent for evidence-based research and architecture analysis.",
  "settings.agents.role.worker": "Strong implementation subagent for code changes, bug fixes, tests, and verification.",
