...
export const dict = {
  ...
  "plugin.catalog.loading": "กำลังโหลดปลั๊กอิน…",
  "plugin.catalog.empty": "ไม่มีปลั๊กอินที่พร้อมใช้งาน",
  "plugin.catalog.failed": "ไม่สามารถโหลดปลั๊กอินได้",
  "plugin.catalog.retry": "ลองอีกครั้ง",
  "plugin.catalog.stale": "กำลังแสดงรายการปลั๊กอินที่โหลดล่าสุด",
  "plugin.catalog.filteredEmpty": "ไม่มีปลั๊กอินที่ตรงกับการค้นหานี้",
  "plugin.runtime.initializing": "กำลังเริ่มต้น",
  "plugin.runtime.ready": "พร้อม",
  "plugin.runtime.degraded": "พร้อมใช้งานบางส่วน",
  "plugin.runtime.failed": "ไม่พร้อมใช้งาน",
  "plugin.runtime.stale": "สถานะอาจไม่เป็นปัจจุบัน",
  "plugin.capability.skills": "ทักษะ",
  "plugin.capability.commands": "คำสั่ง",
  "plugin.capability.mcp": "MCP",
  "plugin.capability.plugin": "ฮุกปลั๊กอิน",
  "plugin.capability.tools": "เครื่องมือ",
