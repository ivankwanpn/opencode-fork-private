...
export const dict = {
  ...
  "ui.sessionTurn.status.compacting": "Bağlam sıkıştırılıyor",
  "ui.sessionTurn.status.waitingForInput": "Girdiniz bekleniyor",
  ...
  "ui.messagePart.shell.background": "Arka plana taşı",
  "ui.messagePart.shell.backgroundUnavailable": "Eşleşen bir ön plan kabuk görevi bulunamadı.",
