...
import { NativeWorkspace } from "@/control-plane/native-workspace"
...
const serverHandlers = handlers.pipe(
  ...
  Layer.provide(NativeConfig.layer),
...
export const nativeRoutes = createNativeRoutes()
...
export const nativeWebHandler = lazy(() =>
  HttpRouter.toWebHandler(nativeRoutes, {
    disableLogger: true,
    memoMap,
    middleware: disposeMiddleware,
  }),
