export const dict = {
  ...
  "ui.sessionTurn.status.compacting": "Сжатие контекста",
  "ui.sessionTurn.status.waitingForInput": "Ожидание вашего ответа",
  ...
  "ui.messagePart.shell.background": "Перевести в фоновый режим",
  "ui.messagePart.shell.backgroundUnavailable": "Подходящая задача оболочки на переднем плане не найдена.",
