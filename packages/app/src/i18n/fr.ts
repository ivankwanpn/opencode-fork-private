...
export const dict = {
  ...
  "plugin.status.enabled": "Activé",
  "plugin.status.disabled": "Désactivé",
  "plugin.catalog.loading": "Chargement des plugins…",
  "plugin.catalog.empty": "Aucun plugin disponible",
  "plugin.catalog.failed": "Impossible de charger les plugins",
  "plugin.catalog.retry": "Réessayer",
  "plugin.catalog.stale": "Affichage de la dernière liste de plugins chargée",
  "plugin.catalog.filteredEmpty": "Aucun plugin ne correspond à cette recherche",
  "plugin.runtime.initializing": "Initialisation",
  "plugin.runtime.ready": "Prêt",
  "plugin.runtime.degraded": "Partiellement disponible",
  "plugin.runtime.failed": "Indisponible",
  "plugin.runtime.stale": "L’état peut être obsolète",
  "plugin.capability.skills": "Compétences",
  "plugin.capability.commands": "Commandes",
  "plugin.capability.mcp": "MCP",
  "plugin.capability.plugin": "Hooks du plugin",
  "plugin.capability.tools": "Outils",
  ...
  "context.usage.window": "Fenêtre de contexte",
  "context.usage.used": "Utilisé {{used}} / {{limit}}",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
