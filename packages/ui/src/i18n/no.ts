...
export const dict: Record<Keys, string> = {
  ...
  "ui.sessionTurn.status.waitingForInput": "Venter på inndata",
  ...
  "ui.messagePart.shell.background": "Flytt til bakgrunnen",
  "ui.messagePart.shell.backgroundUnavailable": "Fant ingen samsvarende skalloppgave i forgrunnen.",
