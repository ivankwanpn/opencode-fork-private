export const dict: Record<string, string> = {
  ...
  "ui.sessionTurn.status.compacting": "Стиснення контексту",
  "ui.sessionTurn.status.waitingForInput": "Очікування вашої відповіді",
  ...
  "ui.messagePart.shell.background": "Перемістити у фоновий режим",
  "ui.messagePart.shell.backgroundUnavailable": "Відповідне завдання оболонки переднього плану не знайдено.",
