...
import type {
  ...
  ServerConsoleConsoleGetErrors,
  ServerConsoleConsoleGetResponses,
  ServerConsoleConsoleOrgListErrors,
  ServerConsoleConsoleOrgListResponses,
  ServerConsoleConsoleOrgSwitchErrors,
  ServerConsoleConsoleOrgSwitchResponses,
  ServerControlPlaneControlPlaneMoveSessionErrors,
  ServerControlPlaneControlPlaneMoveSessionResponses,
  ServerFormatterFormatterStatusErrors,
  ServerFormatterFormatterStatusResponses,
  ServerMcpMcpConnectErrors,
  ServerMcpMcpConnectResponses,
  ServerMcpMcpDisconnectErrors,
  ServerMcpMcpDisconnectResponses,
  ServerMcpMcpResourcesErrors,
  ...
  ServerVcsVcsGetResponses,
  ServerVcsVcsStatusErrors,
  ServerVcsVcsStatusResponses,
  ServerWorkspaceWorkspaceAdapterListErrors,
  ServerWorkspaceWorkspaceAdapterListResponses,
  ServerWorkspaceWorkspaceCreateErrors,
  ServerWorkspaceWorkspaceCreateResponses,
  ServerWorkspaceWorkspaceListErrors,
  ServerWorkspaceWorkspaceListResponses,
  ServerWorkspaceWorkspaceRemoveErrors,
  ServerWorkspaceWorkspaceRemoveResponses,
  ServerWorkspaceWorkspaceStartErrors,
  ServerWorkspaceWorkspaceStartResponses,
  ServerWorkspaceWorkspaceStatusErrors,
  ServerWorkspaceWorkspaceStatusResponses,
  ServerWorkspaceWorkspaceSyncListErrors,
  ServerWorkspaceWorkspaceSyncListResponses,
  ServerWorkspaceWorkspaceWarpErrors,
  ServerWorkspaceWorkspaceWarpResponses,
  SessionAbortErrors,
  ...
  V2CapabilityGetErrors,
  V2CapabilityGetResponses,
  V2CommandListErrors,
  ...
  V2LocationDisposeErrors,
  V2LocationDisposeResponses,
  V2LocationGetErrors,
  ...
  V2ProjectCopyGenerateNameErrors,
  V2ProjectCopyGenerateNameResponses,
...
export class Location extends HeyApiClient {
   ...
   * Dispose location
   *
   * Release cached services and resources for the requested location.
   */
  public dispose<ThrowOnError extends boolean = false>(
    parameters?: {
      location?: {
    ...
    return (options?.client ?? this.client).delete<V2LocationDisposeResponses, V2LocationDisposeErrors, ThrowOnError>({
      url: "/api/location",
      ...options,
      ...params,
    })
...
export class Path2 extends HeyApiClient {
  /**
   * Get paths
   *
   * Retrieve global and location-scoped filesystem paths.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      location?: {
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "query", key: "location" }] }])
    return (options?.client ?? this.client).get<V2PathGetResponses, V2PathGetErrors, ThrowOnError>({
      url: "/api/path",
      ...options,
      ...params,
    })
...
export class Session3 extends HeyApiClient {
   ...
   * Delete session
   *
   * Interrupt and recursively delete a Session and its descendants.
   */
  public remove<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
   ...
   * Update session
   *
   * Update the Session title or archive timestamp while preserving all other fields.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
   ...
   *
   * Retrieve direct child sessions in stable creation order.
   */
  public children<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
   ...
   * Get session todos
   *
   * Retrieve the canonical todo list for a session in stable display order.
   */
  public todo<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
   ...
   * Fork session
   *
   * Create a canonical Session from the unified transcript before an optional exclusive boundary.
   */
  public fork<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
   ...
   * Unshare session
   *
   * Remove the host-provided share for the Session.
   */
  public unshare<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
   ...
   * Share session
   *
   * Create or return a host-provided share URL for the Session.
   */
  public share<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
   ...
   * Get session diff
   *
   * Retrieve the file changes associated with one user turn.
   */
  public diff<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
   ...
   * Run command
   *
   * Expand and durably admit one configured command, then schedule execution unless resume is false.
   */
  public command<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
   ...
   * Run shell command
   *
   * Run one serialized user shell command and record its canonical Session projection.
   */
  public shell<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Custom extends HeyApiClient {
   ...
   *
   * Discover models exposed by a custom provider endpoint.
   */
  public discover<ThrowOnError extends boolean = false>(
    parameters: {
      location?: {
      ...
      customProviderDiscoverInput: CustomProviderDiscoverInput
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams(
      ...
      [
        {
          args: [
            { in: "query", key: "location" },
            { key: "customProviderDiscoverInput", map: "body" },
          ],
        },
      ],
    )
   ...
   *
   * Persist a custom provider and its selected models.
   */
  public configure<ThrowOnError extends boolean = false>(
    parameters: {
      ...
      customProviderConfigureInput: CustomProviderConfigureInput
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams(
      ...
      [
        {
          args: [
            { in: "query", key: "location" },
            { key: "customProviderConfigureInput", map: "body" },
          ],
        },
      ],
    )
...
export class Provider2 extends HeyApiClient {
   ...
   *
   * Retrieve all providers and models together with current availability and defaults.
   */
  public catalog<ThrowOnError extends boolean = false>(
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "query", key: "location" }] }])
    return (options?.client ?? this.client).get<V2ProviderCatalogResponses, V2ProviderCatalogErrors, ThrowOnError>({
...
export class Lsp2 extends HeyApiClient {
   ...
   * Get LSP status
   *
   * Retrieve the language server connections for a location.
   */
  public status<ThrowOnError extends boolean = false>(
    parameters?: {
      location?: {
...
export class Project2 extends HeyApiClient {
   ...
   * Initialize git repository
   *
   * Create a git repository for the requested project location and refresh its project identity.
   */
  public initGit<ThrowOnError extends boolean = false>(
    parameters?: {
      location?: {
   ...
   * List project directories
   *
   * Retrieve the root checkout and registered copies for a project.
   */
  public directories<ThrowOnError extends boolean = false>(
    parameters: {
      projectID: string
...
export class Worktree2 extends HeyApiClient {
   ...
   * Remove worktree
   *
   * Remove a git worktree and its project registration.
   */
  public remove<ThrowOnError extends boolean = false>(
    parameters: {
      location?: {
      ...
      projectWorktreeRemove: ProjectWorktreeRemove
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams(
      ...
      [
        {
          args: [
            { in: "query", key: "location" },
            { key: "projectWorktreeRemove", map: "body" },
          ],
        },
      ],
    )
   ...
   * Create worktree
   *
   * Create a git worktree for the current project and run configured startup scripts.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters: {
      location?: {
      ...
      projectWorktreeCreate: ProjectWorktreeCreate
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams(
      ...
      [
        {
          args: [
            { in: "query", key: "location" },
            { key: "projectWorktreeCreate", map: "body" },
          ],
        },
      ],
    )
   ...
   * Reset worktree
   *
   * Reset a worktree to the primary default branch and rerun configured startup scripts.
   */
  public reset<ThrowOnError extends boolean = false>(
    parameters: {
      location?: {
      ...
      projectWorktreeReset: ProjectWorktreeReset
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams(
      ...
      [
        {
          args: [
            { in: "query", key: "location" },
            { key: "projectWorktreeReset", map: "body" },
          ],
        },
      ],
    )
...
export class Capability extends HeyApiClient {
   ...
   *
   * Retrieve optional runtime capabilities available to clients.
   */
  public get<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).get<V2CapabilityGetResponses, V2CapabilityGetErrors, ThrowOnError>({
      url: "/api/capability",
      ...options,
    })
  }
...
export class Config3 extends HeyApiClient {
   ...
   * Update configuration
   *
   * Merge configuration changes into the host's global configuration.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      config?: unknown
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "body", key: "config" }] }])
...
export class Mcp3 extends HeyApiClient {
  public status<ThrowOnError extends boolean = false>(
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "query", key: "location" }] }])
    return (options?.client ?? this.client).get<ServerMcpMcpStatusResponses, ServerMcpMcpStatusErrors, ThrowOnError>({
      url: "/api/mcp",
      ...options,
      ...params,
    })
  ...
  public connect<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<ServerMcpMcpConnectResponses, ServerMcpMcpConnectErrors, ThrowOnError>(
      {
...
export class Vcs2 extends HeyApiClient {
  public get<ThrowOnError extends boolean = false>(
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "query", key: "location" }] }])
    return (options?.client ?? this.client).get<ServerVcsVcsGetResponses, ServerVcsVcsGetErrors, ThrowOnError>({
      url: "/api/vcs",
      ...options,
      ...params,
    })
  ...
  public status<ThrowOnError extends boolean = false>(
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "query", key: "location" }] }])
    return (options?.client ?? this.client).get<ServerVcsVcsStatusResponses, ServerVcsVcsStatusErrors, ThrowOnError>({
      url: "/api/vcs/status",
      ...options,
      ...params,
    })
  ...
  public diff<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<ServerVcsVcsDiffResponses, ServerVcsVcsDiffErrors, ThrowOnError>({
      url: "/api/vcs/diff",
      ...options,
      ...params,
    })
...
export class Vcs3 extends HeyApiClient {
  private _vcs?: Vcs2
  get vcs(): Vcs2 {
...
export class Formatter3 extends HeyApiClient {
...
export class Console2 extends HeyApiClient {
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      location?: {
        directory?: string
...
export class Console3 extends HeyApiClient {
  private _console?: Console2
  get console(): Console2 {
    return (this._console ??= new Console2({ client: this.client }))
  }
}
...
export class Adapter2 extends HeyApiClient {
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      location?: {
        directory?: string
...
export class Workspace2 extends HeyApiClient {
  ...
  private _adapter?: Adapter2
  get adapter(): Adapter2 {
    return (this._adapter ??= new Adapter2({ client: this.client }))
  }
}

export class Workspace3 extends HeyApiClient {
...
export class ControlPlane2 extends HeyApiClient {
  public moveSession<ThrowOnError extends boolean = false>(
    parameters: {
      moveSessionInput: MoveSessionInput
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams([parameters], [{ args: [{ key: "moveSessionInput", map: "body" }] }])
    return (options?.client ?? this.client).post<
      ServerControlPlaneControlPlaneMoveSessionResponses,
      ServerControlPlaneControlPlaneMoveSessionErrors,
      ThrowOnError
...
export class ControlPlane3 extends HeyApiClient {
...
export class Server extends HeyApiClient {
  ...
  private _vcs?: Vcs3
  get vcs(): Vcs3 {
    return (this._vcs ??= new Vcs3({ client: this.client }))
  }

  private _formatter?: Formatter3
  get formatter(): Formatter3 {
    return (this._formatter ??= new Formatter3({ client: this.client }))
  }

  private _console?: Console3
  get console(): Console3 {
    return (this._console ??= new Console3({ client: this.client }))
  }
  ...
  private _workspace?: Workspace3
  get workspace(): Workspace3 {
    return (this._workspace ??= new Workspace3({ client: this.client }))
  }
