export const dict = {
  ...
  "ui.sessionTurn.status.compacting": "コンテキストを圧縮中",
  "ui.sessionTurn.status.waitingForInput": "入力待ち",
  ...
  "ui.messagePart.shell.background": "バックグラウンドに移動",
  "ui.messagePart.shell.backgroundUnavailable": "一致するフォアグラウンドのシェルタスクが見つかりません。",
