...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const handleSubtask = Effect.fn("SessionPrompt.handleSubtask")(function* (input: {
      ...
      const result = yield* taskTool
        .execute(taskArgs, {
          ...
          callID: part.callID,
          extra: { bypassAgentCheck: true, model, promptOps },
          messages: msgs,
    ...
    const currentModel = Effect.fnUntraced(function* (sessionID: SessionID) {
      ...
      if (current?.model) {
        return {
          ...
          ...(current.model.protocol ? { protocol: current.model.protocol } : {}),
        }
      }
    ...
    const createUserMessage = Effect.fn("SessionPrompt.createUserMessage")(function* (input: PromptInput) {
      ...
      const protocol = "protocol" in model ? model.protocol : undefined
      ...
      if (
        ...
        current.model?.protocol !== info.model.protocol
      ) {
      ...
      function* (sessionID: SessionID) {
        ...
        while (true) {
          ...
          if (
            ...
            !hasToolCalls &&
            MessageV2.messageAfter(lastAssistant, lastUser)
          ) {
    ...
    const command = Effect.fn("SessionPrompt.command")(function* (input: CommandInput) {
      ...
      const transformedParts = yield* CommandV2.Service.use((command) =>
      ...
      const result = yield* prompt({
        ...
        model: userModel,
        agent: userAgent,
        parts: [...transformedParts] as unknown as typeof parts,
        variant: input.variant,
      })
