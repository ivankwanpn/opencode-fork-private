    ...
    syncPromptModel(
      {
        model: {
          ...
          protocol: { current: () => "anthropic-messages", set() {} },
        },
      },
      {
        model: {
    ...
    syncPromptModel(
      {
        model: {
          ...
          protocol: { current: () => model.protocol, set() {} },
        },
      },
      {
        model: {
...
describe("restorePromptModel", () => {
  test("restores the persisted prompt model into session selection", () => {
    ...
    const restored = restorePromptModel(
      {
        model: {
          ...
          protocol: {
            ...
            set: (protocol) => calls.push(protocol),
          },
        },
      },
      {
    ...
    expect(calls).toEqual([{ providerID: "anthropic", modelID: "claude" }, "high", "anthropic-messages"])
  })
