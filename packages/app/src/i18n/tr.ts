...
export const dict = {
  ...
  "plugin.catalog.loading": "Eklentiler yükleniyor…",
  "plugin.catalog.empty": "Kullanılabilir eklenti yok",
  "plugin.catalog.failed": "Eklentiler yüklenemedi",
  "plugin.catalog.retry": "Yeniden dene",
  "plugin.catalog.stale": "Son yüklenen eklenti listesi gösteriliyor",
  "plugin.catalog.filteredEmpty": "Bu aramayla eşleşen eklenti yok",
  "plugin.runtime.initializing": "Başlatılıyor",
  "plugin.runtime.ready": "Hazır",
  "plugin.runtime.degraded": "Kısmen kullanılabilir",
  "plugin.runtime.failed": "Kullanılamıyor",
  "plugin.runtime.stale": "Durum güncel olmayabilir",
  "plugin.capability.skills": "Beceriler",
  "plugin.capability.commands": "Komutlar",
  "plugin.capability.mcp": "MCP",
  "plugin.capability.plugin": "Eklenti kancaları",
  "plugin.capability.tools": "Araçlar",
