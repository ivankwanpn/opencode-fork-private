import { customProviderEnglish } from "./en"

export const dict = {
  ...customProviderEnglish,
  "provider.oauth.title": "Provedor OAuth",
  "provider.oauth.authManaged": "As credenciais são gerenciadas por esta conexão.",
  "provider.oauth.discovery.discover": "Descobrir modelos",
  "provider.oauth.discovery.discovering": "Descobrindo modelos...",
  "provider.oauth.discovery.success": "Modelos atuais descobertos",
  "provider.oauth.discovery.cached": "Exibindo modelos em cache ou estáticos do catálogo.",
  "provider.oauth.discovery.failure": "Não foi possível descobrir os modelos. Tente novamente.",
  "provider.oauth.discovery.unsupported": "Este provedor não oferece descoberta de modelos.",
  "provider.oauth.discovery.empty": "Nenhum modelo foi descoberto.",
  "provider.oauth.models.search": "Pesquisar modelos",
  "provider.oauth.models.empty": "Nenhum modelo corresponde à sua pesquisa.",
  "provider.oauth.models.context": "Substituição local de contexto",
  ...
  "plugin.status.enabled": "Ativado",
  "plugin.status.disabled": "Desativado",
  "plugin.catalog.loading": "Carregando plugins…",
  "plugin.catalog.empty": "Nenhum plugin disponível",
  "plugin.catalog.failed": "Não foi possível carregar os plugins",
  "plugin.catalog.retry": "Tentar novamente",
  "plugin.catalog.stale": "Exibindo a última lista de plugins carregada",
  "plugin.catalog.filteredEmpty": "Nenhum plugin corresponde a esta busca",
  "plugin.runtime.initializing": "Inicializando",
  "plugin.runtime.ready": "Pronto",
  "plugin.runtime.degraded": "Parcialmente disponível",
  "plugin.runtime.failed": "Indisponível",
  "plugin.runtime.stale": "O status pode estar desatualizado",
  "plugin.capability.skills": "Habilidades",
  "plugin.capability.commands": "Comandos",
  "plugin.capability.mcp": "MCP",
  "plugin.capability.plugin": "Ganchos do plugin",
  "plugin.capability.tools": "Ferramentas",
  ...
  "context.usage.window": "Janela de contexto",
  "context.usage.used": "Usado {{used}} / {{limit}}",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "settings.agents.section.coordinators": "Coordenadores principais",
  "settings.agents.section.subagents": "Subagentes de tarefas",
  "settings.agents.role.build": "Coordenador principal com permissões completas de execução.",
  "settings.agents.role.plan": "Coordenador principal para planejamento e trabalhos somente leitura.",
  "settings.agents.role.general": "Subagente de uso geral para tarefas amplas de escopo variado.",
  "settings.agents.role.explore": "Subagente rápido e somente leitura para explorar arquivos e símbolos.",
  "settings.agents.role.research":
    "Subagente aprofundado e somente leitura para pesquisas baseadas em evidências e análise de arquitetura.",
  "settings.agents.role.worker":
    "Subagente de implementação robusto para alterações de código, correções de bugs, testes e verificação.",
