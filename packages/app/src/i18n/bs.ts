...
export const dict = {
  ...
  "plugin.catalog.loading": "Učitavanje dodataka…",
  "plugin.catalog.empty": "Nema dostupnih dodataka",
  "plugin.catalog.failed": "Dodaci se nisu mogli učitati",
  "plugin.catalog.retry": "Pokušaj ponovo",
  "plugin.catalog.stale": "Prikazuje se posljednja učitana lista dodataka",
  "plugin.catalog.filteredEmpty": "Nijedan dodatak ne odgovara ovoj pretrazi",
  "plugin.runtime.initializing": "Pokretanje",
  "plugin.runtime.ready": "Spremno",
  "plugin.runtime.degraded": "Djelimično dostupno",
  "plugin.runtime.failed": "Nedostupno",
  "plugin.runtime.stale": "Status možda nije ažuran",
  "plugin.capability.skills": "Vještine",
  "plugin.capability.commands": "Naredbe",
  "plugin.capability.mcp": "MCP",
  "plugin.capability.plugin": "Kuke dodatka",
  "plugin.capability.tools": "Alati",
