...
export const LocationGroup = HttpApiGroup.make("server.location")
  ...
  .add(
    HttpApiEndpoint.delete("location.dispose", "/api/location", {
      query: LocationQuery,
      ...
      .annotateMerge(
        OpenApi.annotations({
          identifier: "v2.location.dispose",
          summary: "Dispose location",
          description: "Release cached services and resources for the requested location.",
        }),
      ),
  )
