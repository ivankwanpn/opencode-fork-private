...
type Endpoint7_4Request = Parameters<RawClient["server.provider"]["provider.custom.discover"]>[0]
...
type Endpoint7_5Request = Parameters<RawClient["server.provider"]["provider.custom.configure"]>[0]
type Endpoint7_5Input = {
  readonly location?: Endpoint7_5Request["query"]["location"]
  readonly providerID: Endpoint7_5Request["payload"]["providerID"]
  readonly name: Endpoint7_5Request["payload"]["name"]
  readonly protocol?: Endpoint7_5Request["payload"]["protocol"]
  readonly update?: Endpoint7_5Request["payload"]["update"]
...
const adaptGroup7 = (raw: RawClient["server.provider"]) => ({
  ...
  discoverCustom: Endpoint7_4(raw),
  configureCustom: Endpoint7_5(raw),
})
