...
export function mapSessionNotFound<A, E, R>(self: Effect.Effect<A, E | SessionV2.NotFoundError, R>) {
  return self.pipe(
...
export function mapExecutionBusy<A, E, R>(self: Effect.Effect<A, E | SessionV2.BusyError, R>) {
  return self.pipe(
