...
export const dict = {
  ...
  "ui.sessionTurn.status.compacting": "正在精简上下文",
  "ui.sessionTurn.status.waitingForInput": "等待你的输入",
  ...
  "ui.messagePart.shell.background": "转到后台运行",
  "ui.messagePart.shell.backgroundUnavailable": "找不到对应的前台 Shell 任务。",
