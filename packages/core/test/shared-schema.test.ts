...
test("Core reuses the canonical shared schemas", async () => {
  ...
  const schemas = [
    ...
    [coreCredential.WellKnown, Credential.WellKnown],
    [coreCredential.Value, Credential.Value],
    [coreCredential.StoredValue, Credential.StoredValue],
    ...
    [coreSessionMessage.SyntheticKind, SessionMessage.SyntheticKind],
