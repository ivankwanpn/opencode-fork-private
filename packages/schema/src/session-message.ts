...
export const User = Schema.Struct({
  ...
  context: Prompt.fields.context,
  files: Prompt.fields.files,
  agents: Prompt.fields.agents,
  system: Prompt.fields.system,
  tools: Prompt.fields.tools,
  format: Prompt.fields.format,
  type: Schema.Literal("user"),
}).annotate({ identifier: "Session.Message.User" })

export const SyntheticKind = Schema.Literals(["plan-mode", "plan-approved", "build-switch"])
export type SyntheticKind = typeof SyntheticKind.Type
...
export const Synthetic = Schema.Struct({
  ...
  kind: SyntheticKind.pipe(optional),
