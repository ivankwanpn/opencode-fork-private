...
const layer = Layer.effectDiscard(
  Effect.gen(function* () {
    ...
    yield* tools
      .register({
        // Low-frequency builtin: keep it out of the default tool list and let
        // the model discover it through tool_search when tracking multi-step work.
        [name]: Tool.withExposure(
          Tool.make({
            description:
