...
export const dict = {
  ...
  "provider.oauth.title": "OAuth プロバイダー",
  "provider.oauth.authManaged": "認証情報はこの接続で管理されます。",
  "provider.oauth.discovery.discover": "モデルを検出",
  "provider.oauth.discovery.discovering": "モデルを検出しています...",
  "provider.oauth.discovery.success": "現在利用可能なモデルを検出しました",
  "provider.oauth.discovery.cached": "キャッシュ済みまたは静的なカタログモデルを表示しています。",
  "provider.oauth.discovery.failure": "モデルを検出できませんでした。もう一度お試しください。",
  "provider.oauth.discovery.unsupported": "このプロバイダーはモデル検出をサポートしていません。",
  "provider.oauth.discovery.empty": "モデルは検出されませんでした。",
  "provider.oauth.models.search": "モデルを検索",
  "provider.oauth.models.empty": "検索に一致するモデルはありません。",
  "provider.oauth.models.context": "ローカルのコンテキスト上書き",
  ...
  "plugin.catalog.loading": "プラグインを読み込んでいます…",
  "plugin.catalog.empty": "利用可能なプラグインはありません",
  "plugin.catalog.failed": "プラグインを読み込めませんでした",
  "plugin.catalog.retry": "再試行",
  "plugin.catalog.stale": "最後に読み込んだプラグイン一覧を表示しています",
  "plugin.catalog.filteredEmpty": "この検索に一致するプラグインはありません",
  "plugin.runtime.initializing": "初期化中",
  "plugin.runtime.ready": "準備完了",
  "plugin.runtime.degraded": "一部利用可能",
  "plugin.runtime.failed": "利用不可",
  "plugin.runtime.stale": "状態が古い可能性があります",
  "plugin.capability.skills": "スキル",
  "plugin.capability.commands": "コマンド",
  "plugin.capability.mcp": "MCP",
  "plugin.capability.plugin": "プラグインフック",
  "plugin.capability.tools": "ツール",
  ...
  "context.usage.used": "使用済み {{used}} / {{limit}}",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
