...
export class Service extends Context.Service<Service, Interface>()("@opencode/v2/McpAuth") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const getOAuthState = Effect.fn("McpAuth.getOAuthState")(function* (mcpName: string) {
      return (yield* get(mcpName))?.oauthState
    })
...
export const node = makeGlobalNode({
  service: Service,
  layer,
  deps: [FSUtil.node, EffectFlock.node, Global.node],
})
