...
const scenarios: Scenario[] = [
  ...
  http.protected.get("/api/provider/catalog", "v2.provider.catalog").json(200, locationData(object)),
  ...
  http.protected.get("/api/pty/shells", "v2.pty.shells").json(200, locationData(array)),
