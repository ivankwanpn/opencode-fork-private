...
import { MoveSession as MoveSessionSchema } from "@opencode-ai/schema/move-session"

export const Destination = MoveSessionSchema.Destination
export type Destination = MoveSessionSchema.Destination

export const Input = MoveSessionSchema.Input
export type Input = MoveSessionSchema.Input
