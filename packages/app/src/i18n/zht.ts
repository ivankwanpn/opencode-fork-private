...
export const dict = {
  "provider.oauth.title": "OAuth 提供者",
  "provider.oauth.authManaged": "憑證由此連線管理。",
  "provider.oauth.discovery.discover": "探索模型",
  "provider.oauth.discovery.discovering": "正在探索模型...",
  "provider.oauth.discovery.success": "已探索到目前模型",
  "provider.oauth.discovery.cached": "正在顯示已快取或靜態目錄模型。",
  "provider.oauth.discovery.failure": "無法探索模型。請重試。",
  "provider.oauth.discovery.unsupported": "此提供者不支援模型探索。",
  "provider.oauth.discovery.empty": "未探索到任何模型。",
  "provider.oauth.models.search": "搜尋模型",
  "provider.oauth.models.empty": "沒有符合搜尋條件的模型。",
  "provider.oauth.models.context": "本機上下文覆寫",
  ...
  "provider.custom.description.prefix": "設定自訂模型提供商。請參閱",
  "provider.custom.description.link": "提供商設定文件",
  "provider.custom.description.suffix": "。",
  "provider.custom.protocol.label": "協定",
  "provider.custom.protocol.openaiResponses": "OpenAI Responses",
  "provider.custom.protocol.openaiCompatible": "OpenAI 相容",
  "provider.custom.protocol.anthropicMessages": "Anthropic Messages",
  "provider.custom.discovery.title": "模型探索",
  "provider.custom.discovery.discover": "探索模型",
  "provider.custom.discovery.discovering": "正在探索...",
  "provider.custom.discovery.retry": "重試",
  "provider.custom.discovery.search": "搜尋已探索的模型",
  "provider.custom.discovery.addSelected": "加入所選模型",
  "provider.custom.discovery.empty": "未探索到任何模型",
  "provider.custom.discovery.failure": "模型探索失敗",
  "provider.custom.discovery.manualFallback": "你隨時可以手動加入模型。",
  "provider.custom.unavailable": "此伺服器不支援自訂供應商",
  ...
  "provider.custom.field.apiKey.editDescription": "留空會保留現有 API 金鑰。",
  ...
  "provider.custom.models.reasoning": "支援推理",
  "provider.custom.models.context.label": "上下文視窗",
  "provider.custom.models.context.placeholder": "例如 128000",
  "provider.custom.models.output.label": "最大輸出",
  "provider.custom.models.output.placeholder": "例如 8192",
  ...
  "provider.custom.error.limit": "必須為正整數",
  "provider.custom.error.limitPair": "上下文與輸出限制必須同時提供",
  "provider.custom.error.outputExceedsContext": "最大輸出不得超過上下文視窗",
  "provider.custom.error.header.format": "標頭名稱無效",
  ...
  "plugin.catalog.loading": "正在載入外掛程式…",
  "plugin.catalog.empty": "沒有可用的外掛程式",
  "plugin.catalog.failed": "無法載入外掛程式",
  "plugin.catalog.retry": "重試",
  "plugin.catalog.stale": "正在顯示上次載入的外掛程式清單",
  "plugin.catalog.filteredEmpty": "沒有外掛程式符合目前搜尋",
  "plugin.runtime.initializing": "正在初始化",
  "plugin.runtime.ready": "可用",
  "plugin.runtime.degraded": "部分可用",
  "plugin.runtime.failed": "不可用",
  "plugin.runtime.stale": "狀態可能已過期",
  "plugin.capability.skills": "技能",
  "plugin.capability.commands": "命令",
  "plugin.capability.mcp": "MCP",
  "plugin.capability.plugin": "外掛程式掛鉤",
  "plugin.capability.tools": "工具",
  ...
  "settings.agents.section.coordinators": "主代理 / 協調者",
  "settings.agents.section.subagents": "任務子代理",
  "settings.agents.role.build": "擁有完整執行權限的主代理協調者。",
  "settings.agents.role.plan": "負責規劃和唯讀工作的主代理協調者。",
  "settings.agents.role.general": "適合廣泛混合任務的通用子代理。",
  "settings.agents.role.explore": "用於檔案和符號探索的快速唯讀子代理。",
  "settings.agents.role.research": "用於證據驅動研究和架構分析的深度唯讀子代理。",
  "settings.agents.role.worker": "用於程式碼修改、修復問題、測試和驗證的高品質執行子代理。",
