...
export const dict = {
  ...
  "provider.custom.protocol.label": "协议",
  "provider.custom.protocol.openaiResponses": "OpenAI Responses",
  "provider.custom.protocol.openaiCompatible": "OpenAI 兼容",
  "provider.custom.protocol.anthropicMessages": "Anthropic Messages",
  "provider.custom.discovery.title": "模型发现",
  "provider.custom.discovery.discover": "发现模型",
  "provider.custom.discovery.discovering": "正在发现...",
  "provider.custom.discovery.retry": "重试",
  "provider.custom.discovery.search": "搜索已发现的模型",
  "provider.custom.discovery.addSelected": "添加所选模型",
  "provider.custom.discovery.empty": "未发现任何模型",
  "provider.custom.discovery.failure": "模型发现失败",
  "provider.custom.discovery.manualFallback": "你始终可以手动添加模型。",
  "provider.custom.unavailable": "此服务器不支持自定义提供商",
  ...
  "provider.custom.field.apiKey.editDescription": "留空会保留现有 API 密钥。",
  ...
  "provider.custom.error.limit": "必须为正整数",
  "provider.custom.error.limitPair": "上下文与输出限制必须同时提供",
  "provider.custom.error.outputExceedsContext": "最大输出不得超过上下文窗口",
  "provider.custom.error.header.format": "请求头名称无效",
  ...
  "plugin.catalog.loading": "正在加载插件…",
  "plugin.catalog.empty": "没有可用的插件",
  "plugin.catalog.failed": "无法加载插件",
  "plugin.catalog.retry": "重试",
  "plugin.catalog.stale": "正在显示上次加载的插件列表",
  "plugin.catalog.filteredEmpty": "没有插件符合当前搜索",
  "plugin.runtime.initializing": "正在初始化",
  "plugin.runtime.ready": "可用",
  "plugin.runtime.degraded": "部分可用",
  "plugin.runtime.failed": "不可用",
  "plugin.runtime.stale": "状态可能已过期",
  "plugin.capability.skills": "技能",
  "plugin.capability.commands": "命令",
  "plugin.capability.mcp": "MCP",
  "plugin.capability.plugin": "插件钩子",
