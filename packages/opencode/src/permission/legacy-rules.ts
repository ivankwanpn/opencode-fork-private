...
export function fromConfig(permission: ConfigPermissionV1.Info) {
  return Object.entries(permission).flatMap(([key, value]): PermissionV1.Rule[] => {
    if (typeof value === "string") return [{ permission: key, action: value, pattern: "*" }]
...
export * as LegacyPermissionRules from "./legacy-rules"
export * as Permission from "./legacy-rules"
