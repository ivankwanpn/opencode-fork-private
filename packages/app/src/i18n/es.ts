...
export const dict = {
  ...
  "provider.oauth.title": "Proveedor OAuth",
  "provider.oauth.authManaged": "Las credenciales se administran mediante esta conexión.",
  "provider.oauth.discovery.discover": "Descubrir modelos",
  "provider.oauth.discovery.discovering": "Descubriendo modelos...",
  "provider.oauth.discovery.success": "Modelos actuales descubiertos",
  "provider.oauth.discovery.cached": "Mostrando modelos del catálogo en caché o estáticos.",
  "provider.oauth.discovery.failure": "No se pudieron descubrir los modelos. Inténtalo de nuevo.",
  "provider.oauth.discovery.unsupported": "Este proveedor no admite el descubrimiento de modelos.",
  "provider.oauth.discovery.empty": "No se descubrieron modelos.",
  "provider.oauth.models.search": "Buscar modelos",
  "provider.oauth.models.empty": "Ningún modelo coincide con tu búsqueda.",
  "provider.oauth.models.context": "Anulación local de contexto",
  ...
  "plugin.catalog.loading": "Cargando plugins…",
  "plugin.catalog.empty": "No hay plugins disponibles",
  "plugin.catalog.failed": "No se pudieron cargar los plugins",
  "plugin.catalog.retry": "Reintentar",
  "plugin.catalog.stale": "Mostrando la última lista de plugins cargada",
  "plugin.catalog.filteredEmpty": "Ningún plugin coincide con esta búsqueda",
  "plugin.runtime.initializing": "Inicializando",
  "plugin.runtime.ready": "Listo",
  "plugin.runtime.degraded": "Parcialmente disponible",
  "plugin.runtime.failed": "No disponible",
  "plugin.runtime.stale": "Es posible que el estado no esté actualizado",
  "plugin.capability.skills": "Habilidades",
  "plugin.capability.commands": "Comandos",
  "plugin.capability.mcp": "MCP",
  "plugin.capability.plugin": "Hooks del plugin",
  "plugin.capability.tools": "Herramientas",
  ...
  "context.usage.window": "Ventana de contexto",
  ...
  "settings.agents.section.coordinators": "Coordinadores principales",
  "settings.agents.section.subagents": "Subagentes de tareas",
  "settings.agents.role.build": "Coordinador principal con permisos de ejecución completos.",
  "settings.agents.role.plan": "Coordinador principal para planificación y trabajo de solo lectura.",
  "settings.agents.role.general": "Subagente de propósito general para tareas amplias de alcance mixto.",
  "settings.agents.role.explore": "Subagente rápido de solo lectura para explorar archivos y símbolos.",
  "settings.agents.role.research":
    "Subagente profundo de solo lectura para investigación basada en evidencia y análisis de arquitectura.",
  "settings.agents.role.worker":
    "Subagente de implementación avanzado para cambios de código, correcciones de errores, pruebas y verificación.",
