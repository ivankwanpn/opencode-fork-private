...
export const dict = {
  ...
  "provider.oauth.title": "Dostawca OAuth",
  "provider.oauth.authManaged": "Dane uwierzytelniające są zarządzane przez to połączenie.",
  "provider.oauth.discovery.discover": "Wykryj modele",
  "provider.oauth.discovery.discovering": "Wykrywanie modeli...",
  "provider.oauth.discovery.success": "Wykryto aktualne modele",
  "provider.oauth.discovery.cached": "Wyświetlane są modele katalogu z pamięci podręcznej lub statyczne.",
  "provider.oauth.discovery.failure": "Nie można wykryć modeli. Spróbuj ponownie.",
  "provider.oauth.discovery.unsupported": "Ten dostawca nie obsługuje wykrywania modeli.",
  "provider.oauth.discovery.empty": "Nie wykryto żadnych modeli.",
  "provider.oauth.models.search": "Szukaj modeli",
  "provider.oauth.models.empty": "Żaden model nie odpowiada wyszukiwaniu.",
  "provider.oauth.models.context": "Lokalne zastąpienie kontekstu",
  ...
  "mcp.status.disconnected": "rozłączono",
  ...
  "plugin.status.enabled": "Włączona",
  "plugin.status.disabled": "Wyłączona",
  "plugin.catalog.loading": "Ładowanie wtyczek…",
  "plugin.catalog.empty": "Brak dostępnych wtyczek",
  "plugin.catalog.failed": "Nie udało się wczytać wtyczek",
  "plugin.catalog.retry": "Spróbuj ponownie",
  "plugin.catalog.stale": "Wyświetlana jest ostatnio wczytana lista wtyczek",
  "plugin.catalog.filteredEmpty": "Żadna wtyczka nie pasuje do tego wyszukiwania",
  "plugin.runtime.initializing": "Inicjowanie",
  "plugin.runtime.ready": "Gotowe",
  "plugin.runtime.degraded": "Częściowo dostępne",
  "plugin.runtime.failed": "Niedostępne",
  "plugin.runtime.stale": "Stan może być nieaktualny",
  "plugin.capability.skills": "Umiejętności",
  "plugin.capability.commands": "Polecenia",
  "plugin.capability.mcp": "MCP",
  "plugin.capability.plugin": "Hooki wtyczki",
  "plugin.capability.tools": "Narzędzia",
  ...
  "context.usage.window": "Okno kontekstu",
  "context.usage.used": "Użyto {{used}} / {{limit}}",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
