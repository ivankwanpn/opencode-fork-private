...
export const dict = {
  ...
  "ui.sessionTurn.status.compacting": "Kontext wird komprimiert",
  "ui.sessionTurn.status.waitingForInput": "Warten auf deine Eingabe",
  ...
  "ui.messagePart.shell.background": "In den Hintergrund verschieben",
  "ui.messagePart.shell.backgroundUnavailable": "Keine passende Shell-Aufgabe im Vordergrund gefunden.",
