...
const OPENAI_RESPONSES_REASONING_EFFORTS = new Set<string>(OpenAIResponsesReasoningEfforts)
...
export const isResponsesReasoningEffort = (effort: unknown): effort is OpenAIResponsesReasoningEffort =>
  typeof effort === "string" && OPENAI_RESPONSES_REASONING_EFFORTS.has(effort)
