...
export const PromptPayload = Schema.Struct(Struct.omit(PromptInput.fields, ["sessionID"]))
export const CommandPayload = Schema.Struct(Struct.omit(CommandInput.fields, ["sessionID"]))
