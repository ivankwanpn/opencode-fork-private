...
export const dict = {
  ...
  "ui.sessionTurn.status.compacting": "Sažimanje konteksta",
  "ui.sessionTurn.status.waitingForInput": "Čekanje na vaš unos",
  ...
  "ui.messagePart.shell.background": "Premjesti u pozadinu",
  "ui.messagePart.shell.backgroundUnavailable": "Nije pronađen odgovarajući shell zadatak u prvom planu.",
