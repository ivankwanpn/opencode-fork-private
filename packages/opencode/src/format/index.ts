...
import { Formatter as FormatterSchema } from "@opencode-ai/schema/formatter"

export const Status = FormatterSchema.Status
export type Status = FormatterSchema.Status
