...
describe("ProviderTransform.variants", () => {
  ...
  test("custom provider protocols retain their native adjustable effort lists", () => {
    const custom = (npm: string, id: string) =>
      createMockModel({
        id: `custom/${id}`,
        providerID: "custom",
        api: {
    ...
    expect(ProviderTransform.variants(custom("@ai-sdk/openai-compatible", "deepseek-r1"))).toEqual({})
  })
