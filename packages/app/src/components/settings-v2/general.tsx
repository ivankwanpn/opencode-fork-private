...
const followupOptions: {
  id: "queue" | "steer"
  label: "settings.general.row.followup.option.queue" | "settings.general.row.followup.option.steer"
}[] = [
  { id: "queue", label: "settings.general.row.followup.option.queue" },
  { id: "steer", label: "settings.general.row.followup.option.steer" },
]
  ...
  return (
    ...
    >
      <SelectV2
        ...
        placement="bottom-end"
        gutter={6}
        current={followupOptions.find((option) => option.id === settings.general.followup()) ?? followupOptions[1]}
        value={(option) => option.id}
        label={(option) => language.t(option.label)}
