...
export const dict = {
  ...
  "provider.oauth.title": "OAuth-leverandør",
  "provider.oauth.authManaged": "Påloggingsinformasjonen administreres av denne tilkoblingen.",
  "provider.oauth.discovery.discover": "Finn modeller",
  "provider.oauth.discovery.discovering": "Finner modeller...",
  "provider.oauth.discovery.success": "Aktuelle modeller funnet",
  "provider.oauth.discovery.cached": "Viser hurtigbufrede eller statiske katalogmodeller.",
  "provider.oauth.discovery.failure": "Kunne ikke finne modeller. Prøv igjen.",
  "provider.oauth.discovery.unsupported": "Denne leverandøren støtter ikke modelloppdagelse.",
  "provider.oauth.discovery.empty": "Ingen modeller ble funnet.",
  "provider.oauth.models.search": "Søk etter modeller",
  "provider.oauth.models.empty": "Ingen modeller samsvarer med søket ditt.",
  "provider.oauth.models.context": "Lokal overstyring av kontekst",
  ...
  "mcp.status.disconnected": "frakoblet",
  ...
  "plugin.status.enabled": "Aktivert",
  "plugin.status.disabled": "Deaktivert",
  "plugin.catalog.loading": "Laster inn programtillegg…",
  "plugin.catalog.empty": "Ingen programtillegg er tilgjengelige",
  "plugin.catalog.failed": "Kunne ikke laste inn programtillegg",
  "plugin.catalog.retry": "Prøv igjen",
  "plugin.catalog.stale": "Viser den sist innlastede listen over programtillegg",
  "plugin.catalog.filteredEmpty": "Ingen programtillegg samsvarer med dette søket",
  "plugin.runtime.initializing": "Initialiserer",
  "plugin.runtime.ready": "Klar",
  "plugin.runtime.degraded": "Delvis tilgjengelig",
  "plugin.runtime.failed": "Utilgjengelig",
  "plugin.runtime.stale": "Statusen kan være utdatert",
  "plugin.capability.skills": "Ferdigheter",
  "plugin.capability.commands": "Kommandoer",
  "plugin.capability.mcp": "MCP",
  "plugin.capability.plugin": "Programtilleggskroker",
  "plugin.capability.tools": "Verktøy",
